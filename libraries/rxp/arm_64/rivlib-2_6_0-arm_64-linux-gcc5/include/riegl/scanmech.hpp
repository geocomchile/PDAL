...
public:
    ...
    enum kind_e { 
        ...
        , mirrorwheel_facetsurfacedistortion
    };
...
/*------------------------------------------------------------------*/
class mirrorwheel_facetsurfacedistortion
        : public mirrorwheel {
...
public:
    ...
    // input parameters
    vec3d rotation_axis_for_s_t_axes;
    vec3d beam_direction_0;
    std::vector<nodes_t> nodes;
    ...
    explicit mirrorwheel_facetsurfacedistortion(
            const scanlib::mirrorwheel& mwn
    );

    virtual kind_e kind() const { return scanmech::mirrorwheel_facetsurfacedistortion; }
